...
import { SimpleTranscribeClient } from "./simpleClient";

export class SimpleTranscribeAdapter implements SpeechToTextPort {
  private client: SimpleTranscribeClient;
  constructor() {
    ...
    this.client = new SimpleTranscribeClient({
      region,
      languageCode: lang,
      chunkMs,
      lowLatency,
