/**
 * Perplexity API Infrastructure - Search
 * 外部API（Perplexity）との通信（検索/リサーチ）を担当
 */
...
export class PerplexitySearchClient implements IResearchAPIRepository {
...
// 互換エイリアス（旧名）
export { PerplexitySearchClient as PerplexityClient };
